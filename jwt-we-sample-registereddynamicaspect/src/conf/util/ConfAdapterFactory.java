...
public class ConfAdapterFactory extends AdapterFactoryImpl {
   ...
   protected ConfSwitch<Adapter> modelSwitch =
      new ConfSwitch<Adapter>() {
         @Override
         public Adapter caseConfModel(ConfModel object) {
            return createConfModelAdapter();
         }
         @Override
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.eclipse.jwt.we.conf.model.ConfModel <em>Model</em>}'.
    * <!-- begin-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.eclipse.jwt.we.conf.model.Profile <em>Profile</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.eclipse.jwt.we.conf.model.Aspect <em>Aspect</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
