 ...
 * <ul>
 *   <li>{@link core.impl.NamedElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link core.impl.NamedElementImpl#getIcon <em>Icon</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NamedElementImpl extends ModelElementImpl implements NamedElement {
   ...
   public void setIcon(String newIcon) {
      ...
      icon = newIcon;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.NAMED_ELEMENT__ICON, oldIcon, icon));
   }
