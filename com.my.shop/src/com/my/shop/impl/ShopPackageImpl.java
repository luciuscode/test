...
import com.my.shop.NamedElement;
...
public class ShopPackageImpl extends EPackageImpl implements ShopPackage {
	 ...
	 * @see com.my.shop.ShopPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static ShopPackage init() {
		...
		ShopPackageImpl theShopPackage = (ShopPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof ShopPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new ShopPackageImpl());
	 ...
	 * @generated
	 */
	public EReference getShop_Categories() {
	 ...
	 * @generated
	 */
	public EReference getCategory_Shop() {
	 ...
	 * @generated
	 */
	public EAttribute getProduct_Avaiable() {
	 ...
	 * @generated
	 */
	public EAttribute getProduct_Score() {
	 ...
	 * @generated
	 */
	public EReference getProduct_SalesMap() {
	 ...
	 * @generated
	 */
	public EAttribute getProduct_Background() {
	...
	public void createPackageContents() {
		...
		createEAttribute(productEClass, PRODUCT__AVAIABLE);
		createEAttribute(productEClass, PRODUCT__SCORE);
		createEReference(productEClass, PRODUCT__SALES_MAP);
		createEAttribute(productEClass, PRODUCT__BACKGROUND);
	...
	public void initializePackageContents() {
		...
		initEReference(getShop_Categories(), this.getCategory(), this.getCategory_Shop(), "categories", null, 0, -1, Shop.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCategory_Shop(), this.getShop(), this.getShop_Categories(), "shop", null, 0, 1, Category.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCategory_Products(), this.getProduct(), this.getProduct_Category(), "products", null, 0, -1, Category.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(productEClass, Product.class, "Product", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getProduct_Category(), this.getCategory(), this.getCategory_Products(), "category", null, 0, 1, Product.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getProduct_Avaiable(), ecorePackage.getEBoolean(), "avaiable", null, 0, 1, Product.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getProduct_Score(), this.getScore(), "score", null, 0, 1, Product.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProduct_SalesMap(), this.getStringToIntegerMapEntry(), null, "salesMap", null, 0, -1, Product.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getProduct_Background(), this.getRGB(), "background", "255,90,150", 0, 1, Product.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(namedElementEClass, NamedElement.class, "NamedElement", IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getNamedElement_Name(), ecorePackage.getEString(), "name", "Unnamed", 0, 1, NamedElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(scoreEEnum, Score.GOOD_LITERAL);
		addEEnumLiteral(scoreEEnum, Score.AVERAGE_LITERAL);
		addEEnumLiteral(scoreEEnum, Score.BAD_LITERAL);
