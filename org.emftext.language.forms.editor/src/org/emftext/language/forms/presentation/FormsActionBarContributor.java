...
/**
 * This is the action bar contributor for the Forms model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FormsActionBarContributor
  ...
  implements ISelectionChangedListener
{
   ...
   * @generated
   */
  public FormsActionBarContributor()
  {
  ...
  {
    toolBarManager.add(new Separator("forms-settings"));
    toolBarManager.add(new Separator("forms-additions"));
  }
  ...
  public void contributeToMenu(IMenuManager menuManager)
  {
    ...
    IMenuManager submenuManager = new MenuManager(formsEditorPlugin.INSTANCE.getString("_UI_FormsEditor_menu"), "org.emftext.language.formsMenuID");
