...
import org.emftext.language.forms.Entity;
import org.emftext.language.forms.FormsFactory;
import org.emftext.language.forms.FormsPackage;

/**
 * This is the item provider adapter for a {@link org.emftext.language.forms.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
      ...
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             ...
             FormsPackage.Literals.ENTITY__ABSTRACT,
             true,
             false,
             false,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
      if (childrenFeatures == null) {
         ...
         childrenFeatures.add(FormsPackage.Literals.ENTITY__FEATURES);
      }
  ...
  public void notifyChanged(Notification notification)
  {
      ...
      switch (notification.getFeatureID(Entity.class)) {
         case FormsPackage.ENTITY__ABSTRACT:
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
      ...
      newChildDescriptors.add
         (createChildParameter
            (FormsPackage.Literals.ENTITY__FEATURES,
             FormsFactory.eINSTANCE.createFeature()));
   }
