...
/**
 * This is the item provider adapter for a {@link com.my.shop.Shop} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ShopItemProvider
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ShopPackage.eINSTANCE.getShop_Categories());
		}
	...
	public Object getImage(Object object) {
		return getResourceLocator().getImage("full/obj16/Shop");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Shop.class)) {
			case ShopPackage.SHOP__NAME:
				...
				return;
			case ShopPackage.SHOP__CATEGORIES:
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ShopPackage.eINSTANCE.getShop_Categories(),
