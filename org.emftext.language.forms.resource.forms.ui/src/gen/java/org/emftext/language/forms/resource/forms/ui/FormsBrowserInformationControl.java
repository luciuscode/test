 ...
 * @since 3.2
 */
public class FormsBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.emftext.language.forms.resource.forms.ui.FormsDocBrowserInformationControlInput fInput;
	 ...
	 */
	public FormsBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public FormsBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public FormsBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.emftext.language.forms.resource.forms.ui.FormsDocBrowserInformationControlInput);
		...
		fInput= (org.emftext.language.forms.resource.forms.ui.FormsDocBrowserInformationControlInput) input;
		...
		org.emftext.language.forms.resource.forms.ui.FormsHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.emftext.language.forms.resource.forms.ui.FormsHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.emftext.language.forms.resource.forms.ui.FormsDocBrowserInformationControlInput getInput() {
		return fInput;
	}
