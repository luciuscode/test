 ...
 */
public class FormsHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static org.emftext.language.forms.resource.forms.ui.FormsPositionHelper positionHelper = new org.emftext.language.forms.resource.forms.ui.FormsPositionHelper();
	...
	private org.emftext.language.forms.resource.forms.ui.FormsTokenScanner scanner;
	...
	private org.emftext.language.forms.resource.forms.ui.FormsEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private org.emftext.language.forms.resource.forms.ui.FormsOccurrence occurrence;
	private org.emftext.language.forms.resource.forms.ui.FormsBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.emftext.language.forms.resource.forms.IFormsBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public FormsHighlighting(org.emftext.language.forms.resource.forms.IFormsTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.emftext.language.forms.resource.forms.ui.FormsColorManager colorManager, org.emftext.language.forms.resource.forms.ui.FormsEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.emftext.language.forms.resource.forms.ui.FormsUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.emftext.language.forms.resource.forms.ui.FormsTokenScanner(textResource, colorManager);
		occurrence = new org.emftext.language.forms.resource.forms.ui.FormsOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.emftext.language.forms.resource.forms.ui.FormsBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.emftext.language.forms.resource.forms.ui.FormsPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.emftext.language.forms.resource.forms.ui.FormsPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.emftext.language.forms.resource.forms.ui.FormsEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, org.emftext.language.forms.resource.forms.ui.FormsPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.emftext.language.forms.resource.forms.ui.FormsPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.emftext.language.forms.resource.forms.ui.FormsPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.emftext.language.forms.resource.forms.ui.FormsEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
