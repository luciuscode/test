 ...
 * a specified depth.
 */
public class FormsOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public FormsOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = org.emftext.language.forms.resource.forms.util.FormsStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.emftext.language.forms.resource.forms.ui.FormsEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.emftext.language.forms.resource.forms.mopp.FormsPlugin.logError("Exception while refreshing outline view", e);
		}
	}
