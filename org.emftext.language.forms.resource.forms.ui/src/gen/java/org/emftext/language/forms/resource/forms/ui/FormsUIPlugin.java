 ...
 */
public class FormsUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.emftext.language.forms.resource.forms.ui";
	public static final String EDITOR_ID = "org.emftext.language.forms.resource.forms.ui.FormsEditor";
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, FormsUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, FormsUIPlugin.PLUGIN_ID, message);
		}
		final FormsUIPlugin pluginInstance = FormsUIPlugin.getDefault();
