 ...
 */
public class FormsSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public FormsSyntaxColoringPreferencePage() {
		super();
		
		org.emftext.language.forms.resource.forms.mopp.FormsMetaInformation metaInformation = new org.emftext.language.forms.resource.forms.mopp.FormsMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.emftext.language.forms.resource.forms.ui.FormsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.forms.resource.forms.ui.FormsSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.emftext.language.forms.resource.forms.ui.FormsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.forms.resource.forms.ui.FormsSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.emftext.language.forms.resource.forms.ui.FormsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.forms.resource.forms.ui.FormsSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.emftext.language.forms.resource.forms.ui.FormsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.forms.resource.forms.ui.FormsSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.emftext.language.forms.resource.forms.ui.FormsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.forms.resource.forms.ui.FormsSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.emftext.language.forms.resource.forms.ui.FormsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.forms.resource.forms.ui.FormsSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		org.emftext.language.forms.resource.forms.ui.FormsPixelConverter pixelConverter = new org.emftext.language.forms.resource.forms.ui.FormsPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.emftext.language.forms.resource.forms.ui.FormsEditor) {
			org.emftext.language.forms.resource.forms.ui.FormsEditor emfTextEditor = (org.emftext.language.forms.resource.forms.ui.FormsEditor) editor;
