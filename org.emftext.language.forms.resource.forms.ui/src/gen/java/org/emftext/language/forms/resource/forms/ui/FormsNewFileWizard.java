...
public class FormsNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private org.emftext.language.forms.resource.forms.ui.FormsNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public FormsNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new org.emftext.language.forms.resource.forms.ui.FormsNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			org.emftext.language.forms.resource.forms.ui.FormsUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			org.emftext.language.forms.resource.forms.ui.FormsUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new org.emftext.language.forms.resource.forms.mopp.FormsMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new org.emftext.language.forms.resource.forms.mopp.FormsMetaInformation().getSyntaxName();
	}
	
	public org.emftext.language.forms.resource.forms.IFormsMetaInformation getMetaInformation() {
		return new org.emftext.language.forms.resource.forms.mopp.FormsMetaInformation();
	}
