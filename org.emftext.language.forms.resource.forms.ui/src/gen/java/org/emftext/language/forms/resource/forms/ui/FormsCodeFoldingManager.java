...
public class FormsCodeFoldingManager {
	...
	private class FoldingUpdateListener implements org.emftext.language.forms.resource.forms.IFormsBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.emftext.language.forms.resource.forms.ui.FormsEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.emftext.language.forms.resource.forms.ui.FormsEditor) {
				org.emftext.language.forms.resource.forms.ui.FormsEditor editor = (org.emftext.language.forms.resource.forms.ui.FormsEditor) workbenchPart;
	...
	protected org.emftext.language.forms.resource.forms.ui.FormsEditor editor;
	 ...
	 */
	public FormsCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.emftext.language.forms.resource.forms.ui.FormsEditor textEditor) {
	...
	private void addCloseListener(final org.emftext.language.forms.resource.forms.ui.FormsEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.emftext.language.forms.resource.forms.ui.FormsUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.emftext.language.forms.resource.forms.IFormsTextResource textResource = (org.emftext.language.forms.resource.forms.IFormsTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
