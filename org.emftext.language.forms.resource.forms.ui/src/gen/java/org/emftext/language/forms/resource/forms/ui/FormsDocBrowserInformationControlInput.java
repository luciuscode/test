 ...
 * olInput</code>.
 */
public class FormsDocBrowserInformationControlInput {
	
	private final FormsDocBrowserInformationControlInput fPrevious;
	private FormsDocBrowserInformationControlInput fNext;
	 ...
	 */
	public FormsDocBrowserInformationControlInput(FormsDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public FormsDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public FormsDocBrowserInformationControlInput getNext() {
		return fNext;
	}
