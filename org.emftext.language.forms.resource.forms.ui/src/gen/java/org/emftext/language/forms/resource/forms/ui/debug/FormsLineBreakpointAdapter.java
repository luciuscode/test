...
public class FormsLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(org.emftext.language.forms.resource.forms.mopp.FormsPlugin.DEBUG_MODEL_ID);
			...
			org.emftext.language.forms.resource.forms.debug.FormsLineBreakpoint lineBreakpoint = new org.emftext.language.forms.resource.forms.debug.FormsLineBreakpoint(resource, lineNumber + 1);
