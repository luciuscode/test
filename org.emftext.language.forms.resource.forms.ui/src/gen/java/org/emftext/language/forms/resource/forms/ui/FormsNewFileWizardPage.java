 ...
 */
public class FormsNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public FormsNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new forms file");
