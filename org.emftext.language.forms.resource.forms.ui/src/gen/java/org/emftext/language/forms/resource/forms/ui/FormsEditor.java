...
/**
 * A text editor for 'forms' models.
 * <p>
 * This editor has id
 * <code>org.emftext.language.forms.resource.forms.ui.FormsEditor</code>
 * The editor's context menu has id
 * <code>org.emftext.language.forms.resource.forms.EditorContext</code>.
 * The editor's ruler context menu has id
 * <code>org.emftext.language.forms.resource.forms.EditorRuler</code>.
 * </p>
 */
public class FormsEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.emftext.language.forms.resource.forms.IFormsResourceProvider, org.emftext.language.forms.resource.forms.ui.IFormsBracketHandlerProvider, org.emftext.language.forms.resource.forms.ui.IFormsAnnotationModelProvider {
	
	private org.emftext.language.forms.resource.forms.ui.FormsHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.emftext.language.forms.resource.forms.ui.FormsCodeFoldingManager codeFoldingManager;
	private org.emftext.language.forms.resource.forms.ui.FormsBackgroundParsingStrategy bgParsingStrategy = new org.emftext.language.forms.resource.forms.ui.FormsBackgroundParsingStrategy();
	private java.util.Collection<org.emftext.language.forms.resource.forms.IFormsBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.emftext.language.forms.resource.forms.IFormsBackgroundParsingListener>();
	private org.emftext.language.forms.resource.forms.ui.FormsColorManager colorManager = new org.emftext.language.forms.resource.forms.ui.FormsColorManager();
	private org.emftext.language.forms.resource.forms.ui.FormsOutlinePage outlinePage;
	...
	private org.emftext.language.forms.resource.forms.ui.FormsPropertySheetPage propertySheetPage;
	...
	private org.emftext.language.forms.resource.forms.ui.IFormsBracketHandler bracketHandler;
	...
	public FormsEditor() {
		super();
		setSourceViewerConfiguration(new org.emftext.language.forms.resource.forms.ui.FormsSourceViewerConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), FormsEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.emftext.language.forms.resource.forms.IFormsTextResource currentResource = getResource();
				...
				org.emftext.language.forms.resource.forms.ui.FormsUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.emftext.language.forms.resource.forms.EditorContext");
		setRulerContextMenuId("org.emftext.language.forms.resource.forms.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.emftext.language.forms.resource.forms.ui.FormsHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.emftext.language.forms.resource.forms.ui.FormsCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.emftext.language.forms.resource.forms.mopp.FormsNature.activate(inputFile.getProject());
		...
		org.emftext.language.forms.resource.forms.IFormsTextResource loadedResource = (org.emftext.language.forms.resource.forms.IFormsTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.emftext.language.forms.resource.forms.IFormsTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.emftext.language.forms.resource.forms.IFormsTextResource) {
					setResource((org.emftext.language.forms.resource.forms.IFormsTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.emftext.language.forms.resource.forms.ui.FormsUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the FormsEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				org.emftext.language.forms.resource.forms.ui.FormsUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	public org.emftext.language.forms.resource.forms.IFormsTextResource getResource() {
		return resource;
	}
	
	private void setResource(org.emftext.language.forms.resource.forms.IFormsTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.emftext.language.forms.resource.forms.ui.FormsOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.emftext.language.forms.resource.forms.ui.FormsPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.emftext.language.forms.resource.forms.IFormsTextResource textResource = (org.emftext.language.forms.resource.forms.IFormsTextResource) element.eResource();
			org.emftext.language.forms.resource.forms.IFormsLocationMap locationMap = textResource.getLocationMap();
			int destination = locationMap.getCharStart(element);
			int length = locationMap.getCharEnd(element) + 1 - destination;
			
			org.emftext.language.forms.resource.forms.IFormsTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.emftext.language.forms.resource.forms.IFormsTextToken token = lexer.getNextToken();
			...
			org.emftext.language.forms.resource.forms.ui.FormsUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!FormsEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(org.emftext.language.forms.resource.forms.IFormsBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.emftext.language.forms.resource.forms.IFormsBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public org.emftext.language.forms.resource.forms.ui.IFormsBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.emftext.language.forms.resource.forms.ui.IFormsBracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof org.emftext.language.forms.resource.forms.IFormsTextResource)) {
					return false;
				}
				org.emftext.language.forms.resource.forms.IFormsTextResource textResource = (org.emftext.language.forms.resource.forms.IFormsTextResource) resource;
				org.emftext.language.forms.resource.forms.IFormsLocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;
