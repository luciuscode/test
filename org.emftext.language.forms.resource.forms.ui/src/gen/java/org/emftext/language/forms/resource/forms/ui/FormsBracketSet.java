...
public class FormsBracketSet {
	...
	private java.util.ArrayList<org.emftext.language.forms.resource.forms.IFormsBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.emftext.language.forms.resource.forms.IFormsBracketPair {
	 ...
	 */
	private class ClosingListener implements org.emftext.language.forms.resource.forms.ui.IFormsBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.emftext.language.forms.resource.forms.IFormsBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public FormsBracketSet(org.emftext.language.forms.resource.forms.ui.FormsEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.emftext.language.forms.resource.forms.mopp.FormsMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.emftext.language.forms.resource.forms.IFormsBracketPair>();
	 ...
	 */
	public org.emftext.language.forms.resource.forms.IFormsBracketPair getBracketPair(String opening, String closing) {
		for (org.emftext.language.forms.resource.forms.IFormsBracketPair bracketPair : bracketPairs) {
	...
	public org.emftext.language.forms.resource.forms.IFormsBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.emftext.language.forms.resource.forms.IFormsBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.emftext.language.forms.resource.forms.ui.FormsPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.emftext.language.forms.resource.forms.IFormsBracketPair remove(String opening, String closing) {
		for (org.emftext.language.forms.resource.forms.IFormsBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.emftext.language.forms.resource.forms.IFormsBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.emftext.language.forms.resource.forms.ui.FormsPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.emftext.language.forms.resource.forms.ui.FormsPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
