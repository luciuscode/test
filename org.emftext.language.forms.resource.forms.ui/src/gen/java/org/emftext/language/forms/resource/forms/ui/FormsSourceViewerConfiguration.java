 ...
 */
public class FormsSourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	...
	private org.emftext.language.forms.resource.forms.ui.FormsQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public FormsSourceViewerConfiguration(org.emftext.language.forms.resource.forms.IFormsResourceProvider resourceProvider, org.emftext.language.forms.resource.forms.ui.IFormsAnnotationModelProvider annotationModelProvider, org.emftext.language.forms.resource.forms.ui.IFormsBracketHandlerProvider bracketHandlerProvider, org.emftext.language.forms.resource.forms.ui.FormsColorManager colorManager) {
		super(org.emftext.language.forms.resource.forms.ui.FormsUIPlugin.getDefault().getPreferenceStore());
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new org.emftext.language.forms.resource.forms.ui.FormsCompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new org.emftext.language.forms.resource.forms.ui.FormsTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new org.emftext.language.forms.resource.forms.ui.FormsTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new org.emftext.language.forms.resource.forms.ui.FormsHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new org.emftext.language.forms.resource.forms.ui.FormsQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new org.emftext.language.forms.resource.forms.ui.FormsIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}
