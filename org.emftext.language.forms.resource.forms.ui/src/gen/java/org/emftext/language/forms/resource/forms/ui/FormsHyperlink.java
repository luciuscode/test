 ...
 */
public class FormsHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public FormsHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.emftext.language.forms.resource.forms.mopp.FormsPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
