 ...
 */
public class FormsPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(org.emftext.language.forms.resource.forms.ui.FormsUIPlugin.getDefault().getPreferenceStore());
		setDescription("Forms Text Editor Preferences");
	}
