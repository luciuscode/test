 ...
 */
public class FormsBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.emftext.language.forms.resource.forms.IFormsTextResource resource, final org.emftext.language.forms.resource.forms.ui.FormsEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final org.emftext.language.forms.resource.forms.IFormsTextResource resource, final org.emftext.language.forms.resource.forms.ui.FormsEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.emftext.language.forms.resource.forms.IFormsTextResource resource, final org.emftext.language.forms.resource.forms.ui.FormsEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof org.emftext.language.forms.resource.forms.mopp.FormsResource) {
							org.emftext.language.forms.resource.forms.mopp.FormsResource concreteResource = (org.emftext.language.forms.resource.forms.mopp.FormsResource) resource;
