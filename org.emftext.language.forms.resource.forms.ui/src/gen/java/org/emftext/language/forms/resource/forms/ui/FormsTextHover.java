 ...
 */
public class FormsTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	
	private static final String FONT = org.eclipse.jface.resource.JFaceResources.DIALOG_FONT;
	
	private org.emftext.language.forms.resource.forms.IFormsResourceProvider resourceProvider;
	private org.emftext.language.forms.resource.forms.IFormsHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.emftext.language.forms.resource.forms.ui.FormsBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.emftext.language.forms.resource.forms.ui.FormsBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.emftext.language.forms.resource.forms.ui.FormsDocBrowserInformationControlInput infoInput = (org.emftext.language.forms.resource.forms.ui.FormsDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.emftext.language.forms.resource.forms.ui.FormsHyperlink hyperlink = new org.emftext.language.forms.resource.forms.ui.FormsHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.emftext.language.forms.resource.forms.ui.FormsBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.emftext.language.forms.resource.forms.ui.FormsBrowserInformationControl iControl = new org.emftext.language.forms.resource.forms.ui.FormsBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.emftext.language.forms.resource.forms.ui.FormsDocBrowserInformationControlInput) {
							org.emftext.language.forms.resource.forms.ui.FormsDocBrowserInformationControlInput input = (org.emftext.language.forms.resource.forms.ui.FormsDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.emftext.language.forms.resource.forms.ui.FormsBrowserInformationControl.isAvailable(parent)) {
				org.emftext.language.forms.resource.forms.ui.FormsBrowserInformationControl iControl = new org.emftext.language.forms.resource.forms.ui.FormsBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public FormsTextHover(org.emftext.language.forms.resource.forms.IFormsResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.emftext.language.forms.resource.forms.ui.FormsUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((org.emftext.language.forms.resource.forms.ui.FormsDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private org.emftext.language.forms.resource.forms.ui.FormsDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		org.emftext.language.forms.resource.forms.IFormsTextResource textResource = resourceProvider.getResource();
	 ...
	 */
	private org.emftext.language.forms.resource.forms.ui.FormsDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.emftext.language.forms.resource.forms.ui.FormsDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.emftext.language.forms.resource.forms.ui.FormsHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.emftext.language.forms.resource.forms.ui.FormsHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.emftext.language.forms.resource.forms.ui.FormsHTMLPrinter.insertPageProlog(buffer, 0, org.emftext.language.forms.resource.forms.ui.FormsTextHover.getStyleSheet());
			org.emftext.language.forms.resource.forms.ui.FormsHTMLPrinter.addPageEpilog(buffer);
			return new org.emftext.language.forms.resource.forms.ui.FormsDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = org.emftext.language.forms.resource.forms.ui.FormsHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.emftext.language.forms.resource.forms.ui.FormsUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.emftext.language.forms.resource.forms.util.FormsStreamUtil.getContent(styleSheetURL.openStream());
