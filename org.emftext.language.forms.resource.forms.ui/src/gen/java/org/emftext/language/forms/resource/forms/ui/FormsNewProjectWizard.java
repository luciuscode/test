 ...
 */
public class FormsNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new org.emftext.language.forms.resource.forms.mopp.FormsMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.emftext.language.forms.resource.forms.ui");
							...
							String natureID = org.emftext.language.forms.resource.forms.mopp.FormsNature.NATURE_ID;
							...
							for (String builderID : org.emftext.language.forms.resource.forms.mopp.FormsNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								org.emftext.language.forms.resource.forms.mopp.FormsMetaInformation info = new org.emftext.language.forms.resource.forms.mopp.FormsMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = org.emftext.language.forms.resource.forms.ui.FormsUIPlugin.getDefault().getBundle();
