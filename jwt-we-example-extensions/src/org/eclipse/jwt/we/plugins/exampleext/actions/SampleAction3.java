		...
		extends WEExternalAction
{
	...
	{
		return Activator.getImageDescriptor("icons/action3.gif");
	}


	public void run()
	{
		String info = "This is SampleAction 3 with the following properties:\n"
				+ "- name is Sample3\n" + "- shown ONLY in toolbar\n"
				+ "- provides an image\n"
				+ "- forces text display in toolbar (even with image present)\n"
