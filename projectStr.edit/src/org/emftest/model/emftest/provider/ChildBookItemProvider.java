...
/**
 * This is the item provider adapter for a {@link org.emftest.model.emftest.ChildBook} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChildBookItemProvider
	 ...
	 * @generated
	 */
	public ChildBookItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ChildBook"));
	}
	...
	public String getText(Object object) {
		String label = ((ChildBook)object).getTitle();
		return label == null || label.length() == 0 ?
			getString("_UI_ChildBook_type") :
			getString("_UI_ChildBook_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ChildBook.class)) {
			case emftestPackage.CHILD_BOOK__TITLE:
			case emftestPackage.CHILD_BOOK__PAGES:
