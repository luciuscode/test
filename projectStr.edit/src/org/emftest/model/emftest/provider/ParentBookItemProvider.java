...
/**
 * This is the item provider adapter for a {@link org.emftest.model.emftest.ParentBook} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParentBookItemProvider
	 ...
	 * @generated
	 */
	public ParentBookItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 emftestPackage.Literals.BOOK__TITLE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 emftestPackage.Literals.BOOK__PAGES,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 emftestPackage.Literals.BOOK__AUTHORS,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ParentBook"));
	}
	...
	public String getText(Object object) {
		String label = ((ParentBook)object).getTitle();
		return label == null || label.length() == 0 ?
			getString("_UI_ParentBook_type") :
			getString("_UI_ParentBook_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ParentBook.class)) {
